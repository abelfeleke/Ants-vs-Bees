...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            if isinstance(insect,QueenAnt) and insect.true_queen_created:
                return
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        Ant.__init__(self,armor)
        # BEGIN Problem 13
        if QueenAnt.true_queen_created == False:
            self.true_queen_created = True
            QueenAnt.true_queen_created = True
        else:
            self.true_queen_created = False
    ...
    def action(self, colony):
        ...
        if self.true_queen_created == False:
            Insect.reduce_armor(self, self.armor)
        else:
            ThrowerAnt.action(self,colony)
            while curr_place != None:
                if curr_place.ant != None:
                    if curr_place.ant not in QueenAnt.buffed_ants:
                        curr_place.ant.damage *= 2
                        QueenAnt.buffed_ants.append(curr_place.ant)
                    if curr_place.ant.is_container and curr_place.ant.contained_ant not in QueenAnt.buffed_ants and curr_place.ant.contained_ant:
                        curr_place.ant.contained_ant.damage *= 2
                        QueenAnt.buffed_ants.append(curr_place.ant.contained_ant)
    ...
    def reduce_armor(self, amount):
        ...
        self.armor-=amount
        if self.armor == 0 and self.true_queen_created:
            bees_win()
